      ...
      <body className="min-h-full flex flex-col bg-background font-sans">
        <div className="flex flex-col items-center justify-center min-h-dvh bg-background p-6 font-sans relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-md w-full">
            ...
            <h1 className="text-4xl font-black text-white mb-4 tracking-tight">Something broke.</h1>
            <p className="text-text-secondary text-sm mb-10 leading-relaxed">
              We encountered an unexpected system error. Our team has been automatically notified. Please try refreshing or return to your dashboard.
            </p>
